...
- rpc-provider/target/rpc-provider-1.0-SNAPSHOT.jar
- rpc-consumer/target/rpc-consumer-1.0-SNAPSHOT.jar
...
```bash
cd D:\RPC-Java\rpc-provider
D:\software\JDK17\bin\java -cp "target\rpc-provider-1.0-SNAPSHOT.jar;target\lib\*" com.rpc.provider.ProviderTest
```
...
```
cd D:\RPC-Java\rpc-consumer
D:\software\JDK17\bin\java -cp "target\rpc-consumer-1.0-SNAPSHOT.jar;target\lib\*" com.rpc.consumer.ConsumerTest
```
